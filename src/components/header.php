<?php
session_start();
$url_base="http://localhost/almacen/";
...
<link rel="stylesheet" href="<?php echo $url_base; ?>src/assets/css/style.css">
<link rel="shortcut icon" href="<?php echo $url_base; ?>public/logo.png" type="image/x-icon">
...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo $url_base; ?>index.php">Almacen</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo $url_base; ?>src/components/templates/employees/"><svg
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?php echo $url_base; ?>src/components/templates/jobs/index.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="<?php echo $url_base; ?>src/components/templates/consultas/index.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="<?php echo $url_base; ?>src/components/templates/materiales/index.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="<?php echo $url_base; ?>src/components/templates/usuarios/index.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link"
                                href="<?php echo $url_base; ?>src/components/templates/settings/index.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <!-- <li class="nav-item"> -->
                        <br>
                        <a href="<?php echo $url_base?>cerrar.php" class="btn btn-danger">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <main class="container d-flex justify-content-center align-items-center flex-column mt-4" >
